...
Navigation uses **Hotwire Turbo** (`@hotwired/turbo-rails` in the esbuild bundle). Custom UI behaviors use **Stimulus** controllers under `app/javascript/controllers/`. Flash messages use Bootstrap toasts (`flash_toasts.js`), not gritter.
